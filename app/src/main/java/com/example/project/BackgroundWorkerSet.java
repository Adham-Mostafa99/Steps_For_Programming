...
public class BackgroundWorkerSet extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        String login_url = "http://emp010.ga/update.php";
        if (type.equals("login")) {

            try {
                String rate_name = params[1];
                String rate_value=params[2];
                ...
                String post_data = URLEncoder.encode("rateid", "UTF-8") + "=" + URLEncoder.encode(rate_name, "UTF-8")+ "&"
                        + URLEncoder.encode("rating", "UTF-8") + "=" + URLEncoder.encode(rate_value, "UTF-8");
